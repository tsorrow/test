...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_board_temp).setOnClickListener(this);
        findViewById(R.id.btn_board_system).setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_date_picker){
            ...
            startActivity(intent);
        }else if (v.getId() == R.id.btn_board_temp){
            Intent intent = new Intent(this,BroadTempActivity.class);
            startActivity(intent);
        }else if (v.getId() == R.id.btn_board_system){
